      ...
      <div class="pt-8">
        ...
        <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
          ...
          <div class="sm:col-span-3">
            ...
            <div class="mt-2">
              <select id="country" name="role_id" autocomplete="country-name" class="p-3 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
          ...
          <div class="sm:col-span-2">
            <label for="password" class="block text-sm font-medium leading-6 text-gray-900">Password {{$user->id ? '(Optional)' : ''}}</label>
            <div class="mt-2">
          ...
          <div class="sm:col-span-2">
            <label for="repassword" class="block text-sm font-medium leading-6 text-gray-900">Re-entry Password  {{$user->id ? '(Optional)' : ''}}</label>
            <div class="mt-2">
